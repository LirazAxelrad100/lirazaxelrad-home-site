...
const contactIntro =
  "לבדיקת אפשרות של עבודה ביחד, על כל אחד מהנושאים - ניהול מוצר, מדיטציה, הגירה, ביקור בברלין - צרו קשר או קבעו פגישה, ונבדוק אם יש התאמה ועניין ורצון להמשיך. שיחה ראשונה, חצי שעה, חינם.";
